...
def process_patient_folder(patient_folder, type):
    ...
    data.append({'text': description, 'type': type})           

    return data

def generate_csv(data_dir1, data_dir2, data_dir3, data_dir4, data_dir5, output_csv, type0, type1):
...
output_csv = 'Datasets/text.csv'
type0 = 0
type1 = 1

generate_csv(data_dir1, data_dir2, data_dir3, data_dir4, data_dir5, output_csv, type0, type1)
